...
// Leave the placeholders (https://c8ab56ed-ab9f-4b4a-b700-c695543bf1e4.lovableproject.com/api/public/ingest / 73867fd574b52124d8b832d3afcd97ee4b703b0c017f654e) if you're
...
// Takes an int (not LedState) on purpose: the Arduino preprocessor
// auto-inserts a prototype for this function ABOVE the enum declaration,
// so a `LedState` parameter breaks the build ("'LedState' was not
// declared in this scope"). Same reason applySensor() takes an index.
